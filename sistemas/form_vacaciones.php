	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold"></span> VACACIONES A SOLICITAR</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="datatable_vacacion.php" class="breadcrumb-item">LISTADO-VACACIONES</a>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-body">
						<h5 class="card-title" align="center"> <center>EXTRA: EN ESTE APARTADO LO QUE PODRAS HACE SERÁ REGISTRARTU PERMISO PARA TU PERIODO DE VACACIONES CORRESPONDIENTE.<br>NO OLVIDES LLENAR CADA UNO DE LOS CAMPOS. <br> ¡DISFRUTA TUS VACACIONES!</center> <br></h5><br>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											...
											<input type="text" class="form-control border-left-0" placeholder="ej. Daniela Guzmán">
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											...
											<input type="text" class="form-control border-left-0" placeholder="ej. Auxiliar">
										</div>
									</div>
								</div>

								<div class="form-group row">
									<label class="col-form-label col-lg-2">PERIODO VACACIONAL</label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
												<span class="input-group-text bg-primary border-primary text-white">
											...
											<input type="text" class="form-control border-left-0" placeholder="20-10-2018 - 31-10-2018">
										</div>
									</div>
								</div>
							</fieldset>	
				...
				<div id="modal_form_vertical" class="modal fade" tabindex="-1">
					<div class="modal-dialog">
						<div class="modal-content" align="center">
							<div class="modal-header">
								<h5 class="modal-title">EDICIÓN DE SOLICITUD PARA VACACIONES</h5>
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							</div>
						</div>
					</div>
