	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">FORMULARIO</span> - EMPRESAS</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="datatable_empresa.php" class="breadcrumb-item">LISTADO-EMPRESAS</a>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-body">
						<h5 class="card-title" align="center"> EXTRA: EN ESTE APARTADO LO QUE PODRAS HACE SERÁ REGISTRAR UNA EMPRESA, ASEGURATE TENER LOS DATOS BÁSICOS A LA MANO AL REGISTRARLA. <br></h5><br>
						...
						<form action="#">
							...
							<fieldset>
								<div class="form-group row">
									<br>
									<label class="col-form-label col-lg-2">CALVE</label>
									<div class="col-lg-10">
										<div class="input-group">
											...
											<input type="text" class="form-control border-left-0" placeholder=" ej. 01273">
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											...
											<input type="text" class="form-control border-left-0" placeholder="ej. Daniela Industries">
										</div>
									</div>
								</div>

								<div class="form-group row">
									<label class="col-form-label col-lg-2">RFC FISCAL</label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
												<span class="input-group-text ">
											...
											<input type="text" class="form-control border-left-0" placeholder="ej. HVWE121529MB7">
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											...
											<input type="text" class="form-control border-left-0" placeholder="ej. 17 Matamoros">
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											...
											<input type="text" class="form-control border-left-0" placeholder="ej. 87030">
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											...
											<input type="text" class="form-control border-left-0" placeholder="ej. Ciudad de México">
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											...
											<input type="text" class="form-control border-left-0" placeholder="ej. Tamaulipas">
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											...
											<input type="text" class="form-control border-left-0" placeholder="ej. 01 800 132 517">
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											...
											<input type="text" class="form-control border-left-0" placeholder="ejemplo@empresa.com">
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											...
											<input type="text" class="form-control border-left-0" placeholder="ej. esta empresa se encarga de fabricar algunas partes de carro.">
										</div>
									</div>
								</div>
							</fieldset>	
